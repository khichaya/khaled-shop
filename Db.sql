...
-- Dumping database structure for lassouaddb
CREATE DATABASE IF NOT EXISTS `lassouaddb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `lassouaddb`;

-- Dumping structure for table lassouaddb.backups
...
-- Dumping structure for table lassouaddb.cache
...
-- Dumping structure for table lassouaddb.cache_locks
...
-- Dumping structure for table lassouaddb.categories
...
-- Dumping structure for table lassouaddb.customers
...
-- Dumping structure for table lassouaddb.expenses
...
-- Dumping structure for table lassouaddb.failed_jobs
...
-- Dumping structure for table lassouaddb.favorites
CREATE TABLE IF NOT EXISTS `favorites` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` decimal(12,2) NOT NULL,
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#872061',
...
-- Dumping structure for table lassouaddb.institution_settings
CREATE TABLE IF NOT EXISTS `institution_settings` (
  ...
  `rc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ai` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_footer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping structure for table lassouaddb.jobs
...
-- Dumping structure for table lassouaddb.job_batches
...
-- Dumping structure for table lassouaddb.migrations
...
-- Dumping structure for table lassouaddb.online_orders
CREATE TABLE IF NOT EXISTS `online_orders` (
  ...
  `payment_method` enum('cod','baridimob') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cod',
...
-- Dumping structure for table lassouaddb.online_order_items
CREATE TABLE IF NOT EXISTS `online_order_items` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `online_order_items_online_order_id_foreign` (`online_order_id`),
  KEY `online_order_items_product_id_foreign` (`product_id`),
  KEY `online_order_items_variant_id_foreign` (`variant_id`),
  CONSTRAINT `online_order_items_online_order_id_foreign` FOREIGN KEY (`online_order_id`) REFERENCES `online_orders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `online_order_items_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL,
  CONSTRAINT `online_order_items_variant_id_foreign` FOREIGN KEY (`variant_id`) REFERENCES `product_variants` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table lassouaddb.password_reset_tokens
...
-- Dumping structure for table lassouaddb.personal_access_tokens
...
-- Dumping structure for table lassouaddb.products
CREATE TABLE IF NOT EXISTS `products` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `barcode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `box_barcode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping structure for table lassouaddb.product_barcodes
...
-- Dumping structure for table lassouaddb.product_details
...
-- Dumping structure for table lassouaddb.product_images
...
-- Dumping structure for table lassouaddb.product_variants
...
-- Dumping structure for table lassouaddb.purchases
...
-- Dumping structure for table lassouaddb.purchase_items
...
-- Dumping structure for table lassouaddb.roles
...
-- Dumping structure for table lassouaddb.sales
...
-- Dumping structure for table lassouaddb.sale_items
...
-- Dumping structure for table lassouaddb.services
...
-- Dumping structure for table lassouaddb.sessions
...
-- Dumping structure for table lassouaddb.settings
...
-- Dumping structure for table lassouaddb.stock_movements
CREATE TABLE IF NOT EXISTS `stock_movements` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `product_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `type` enum('purchase','sale','return_customer','return_supplier','damage','adjustment') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity` decimal(12,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping structure for table lassouaddb.storage_locations
...
-- Dumping structure for table lassouaddb.suppliers
...
-- Dumping structure for table lassouaddb.units
...
-- Dumping structure for table lassouaddb.users
